...
module PersonaAPIClient
  class ReportSyntheticRequestAttributesAllOfQuery < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PersonaAPIClient::ReportSyntheticRequestAttributesAllOfQuery`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] name_first Value to be assigned
    def name_first=(name_first)
      if name_first.nil?
        fail ArgumentError, 'name_first cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] name_last Value to be assigned
    def name_last=(name_last)
      if name_last.nil?
        fail ArgumentError, 'name_last cannot be nil'
      end
