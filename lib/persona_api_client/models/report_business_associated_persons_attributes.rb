...
module PersonaAPIClient
  class ReportBusinessAssociatedPersonsAttributes < ApiModelBase
    ...
    # List of persons associated with the business
    ...
    def self.openapi_types
      {
        ...
        :'tags' => :'Array<String>',
        :'query' => :'ReportBusinessAssociatedPersonsAttributesAllOfQuery',
        :'associated_persons' => :'Array<ReportBusinessAssociatedPersonsAttributesAllOfAssociatedPersonsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `PersonaAPIClient::ReportBusinessAssociatedPersonsAttributes` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `PersonaAPIClient::ReportBusinessAssociatedPersonsAttributes`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'associated_persons')
        if (value = attributes[:'associated_persons']).is_a?(Array)
          self.associated_persons = value
        end
      else
        self.associated_persons = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @associated_persons.nil?
        invalid_properties.push('invalid value for "associated_persons", associated_persons cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @associated_persons.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] associated_persons Value to be assigned
    def associated_persons=(associated_persons)
      if associated_persons.nil?
        fail ArgumentError, 'associated_persons cannot be nil'
      end
    ...
    def hash
      [status, created_at, completed_at, redacted_at, report_template_version_name, has_match, is_continuous, is_recurring, tags, query, associated_persons].hash
    end
